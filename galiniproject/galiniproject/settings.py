"""
Django settings for galiniproject project.
...
SECRET_KEY = 'django-insecure-t22s7^br8&l0xl9eybr5j-fq)x4buiq7$nn7e@0-7#gfqy!v)4'
...
ROOT_URLCONF = 'galiniproject.urls'
...
WSGI_APPLICATION = 'galiniproject.wsgi.application'
